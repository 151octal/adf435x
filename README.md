...
```cpp
  ...
  As host for the ATMEGA328, the Adafruit 'metro mini' is used which has i2c connectoring and is
  ...
  ADF435x module. Configure the mini for 3V. Supply the ADF435x module from the mini on-board 5v
  regulated output.
  ------------------------------------------------------------------------------------------------
